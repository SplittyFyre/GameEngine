...
import engine.renderEngine.guis.ISlider;
import engine.renderEngine.guis.SFAbstractButton;
import engine.renderEngine.guis.SFVerticalSlider;
import jtrek.box.TM;
...
public class VoyagerGUISys {
	...
	private void setupTactical() {
		...
		Vector2f varl = new Vector2f(0.015f, 0.01f * TRDisplayManager.getAspectRatio());
